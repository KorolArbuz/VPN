...
//
//  Runtime configuration validation and DEBUG-only Xray/Tun2Socks lifecycle
//  diagnostics. Sensitive generated runtime configuration remains in memory.
//
...
protocol PacketTunnelUDPControlProbing: Sendable {
    func runUDPControlProbe(correlationID: UUID, requestGeneration: UInt64?) async -> TunnelUDPControlProbeResponse
}
